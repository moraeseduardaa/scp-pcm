        ...
        <div class="col-md-6">
          <div class="card shadow-lg">
            <div class="card-body text-center p-5">
              ...
              <button class="btn btn-danger btn-lg px-5" @click="fazerLogin" :disabled="!operadorSelecionado"
                style="border-radius: 50px;">
                <i class="bi bi-arrow-right-circle me-2"></i>
                Entrar
              </button>
              <span class="config-icon" @click="abrirLoginPcm">
...
const loginPcmKey = ref(0);

const emit = defineEmits(['login-realizado', 'abrir-login-pcm']);

function abrirLoginPcm() {
  emit('abrir-login-pcm');
}
